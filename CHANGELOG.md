...
## [8.0.0](https://github.com/john-hen/snakemake/compare/v7.15.1...v8.0.0) (2022-10-06)
...
* Add `shadow: "copy-minimal"` directive ([#1155](https://github.com/john-hen/snakemake/issues/1155)) ([1803f0b](https://github.com/john-hen/snakemake/commit/1803f0b4090d812df0c164653b26502fd130d326))
* add Bash script functionality ([#1821](https://github.com/john-hen/snakemake/issues/1821)) ([c4cf8fd](https://github.com/john-hen/snakemake/commit/c4cf8fdb119e678e51fd1932392699957c63b6c4))
* add flag --draft-notebook for generating a skeleton notebook for manual editing (e.g. in VSCode). ([#1284](https://github.com/john-hen/snakemake/issues/1284)) ([d279322](https://github.com/john-hen/snakemake/commit/d2793223f914790c07b25363cb9b314ef166cb3e))
* add flag `ensure` that allows to annotate that certain output files should be non-empty or agree with a given checksum ([#1651](https://github.com/john-hen/snakemake/issues/1651)) ([76f69d9](https://github.com/john-hen/snakemake/commit/76f69d9e21b9c9a9a01198862b66284bc3942d20))
* add gitfile option to make it possible to use local git repos when importing modules ([#1376](https://github.com/john-hen/snakemake/issues/1376)) ([1a3b91f](https://github.com/john-hen/snakemake/commit/1a3b91fa8461d44bc1583f1d2e33ff2bae1360b3))
* Add more informative errors when evaluation of `--default-resources` fails ([#1192](https://github.com/john-hen/snakemake/issues/1192)) ([b3c4e68](https://github.com/john-hen/snakemake/commit/b3c4e687c87c75075393cef842b129dcec70e7f6))
* add pyproject.toml to use setuptools features ([#1725](https://github.com/john-hen/snakemake/issues/1725)) ([454bfd1](https://github.com/john-hen/snakemake/commit/454bfd17aba8631ea34d6a8971b1db60b2955965))
* Add support for rust scripts (enabling directly integrated ad-hoc robust high performance scripting) ([#1053](https://github.com/john-hen/snakemake/issues/1053)) ([f0e8fa2](https://github.com/john-hen/snakemake/commit/f0e8fa285437a02ca7edcf87334bf00cb347064a))
* Added timestamp to each log message ([#1304](https://github.com/john-hen/snakemake/issues/1304)) ([a5769f0](https://github.com/john-hen/snakemake/commit/a5769f0baeaa829b7813dee8c78902edbb42cf4b))
* Adding --cluster-cancel and --cluster-cancel-nargs ([#1395](https://github.com/john-hen/snakemake/issues/1395)) ([0593de1](https://github.com/john-hen/snakemake/commit/0593de134499712929ba75e65f65df90491eac2e))
* adding default_target directive for declaring default target rules that are not the first rule in the workflow. ([#1358](https://github.com/john-hen/snakemake/issues/1358)) ([638ec1a](https://github.com/john-hen/snakemake/commit/638ec1a983741cd7ba8faaf1a9dc76ae43d012e5))
* adding flux executor ([#1810](https://github.com/john-hen/snakemake/issues/1810)) ([40d2bd0](https://github.com/john-hen/snakemake/commit/40d2bd071984914ac511e7858690dfd16cefaf69))
* adding service jobs, i.e. the ability to define jobs that provide a resource for consumers (like a shared memory device or a database), and will be automatically terminated by Snakemake once all consumers are finished. ([#1413](https://github.com/john-hen/snakemake/issues/1413)) ([a471adb](https://github.com/john-hen/snakemake/commit/a471adbb785e5ac7f0c854fd09781c502b577c65))
* Allow paramspace to separate filename params with custom separator ([#1299](https://github.com/john-hen/snakemake/issues/1299)) ([8236e80](https://github.com/john-hen/snakemake/commit/8236e80794d0f9c9670238ba168770c0947e8379))
* allow prefix definition in module statements ([#1310](https://github.com/john-hen/snakemake/issues/1310)) ([29e6540](https://github.com/john-hen/snakemake/commit/29e6540aac95b08b5e386a8478bd2013334e5954))
* Allow to mark all output files as temp with --all-temp ([#1097](https://github.com/john-hen/snakemake/issues/1097)) ([0ac3b38](https://github.com/john-hen/snakemake/commit/0ac3b3806c065d0ec3a551a5992faf30ddcf0576))
* autoconvert Path objects to str when passing to R or Julia scripts ([80ec513](https://github.com/john-hen/snakemake/commit/80ec51322f8134180c52c20b0a9dc6980df6c1bc))
* automatically rerun jobs if parameters, code, input file set, or software stack changed (thanks to [@cclienty](https://github.com/cclienty) and [@timtroendle](https://github.com/timtroendle)). This also increases performance of DAG building by handling job "needrun" updates level wise, while avoiding to perform a full check for those jobs that are already downstream of a job that has been determined to require a rerun. ([#1663](https://github.com/john-hen/snakemake/issues/1663)) ([4c11893](https://github.com/john-hen/snakemake/commit/4c11893d2fda5824adff44d16d7741484e63efea))
* cluster sidecar ([#1397](https://github.com/john-hen/snakemake/issues/1397)) ([b992cd1](https://github.com/john-hen/snakemake/commit/b992cd19dc1c011f536e3662a3ddffc8b1bb9f67))
* enable restricted access support in zenodo remote provider ([#1623](https://github.com/john-hen/snakemake/issues/1623)) ([692caf9](https://github.com/john-hen/snakemake/commit/692caf963d90313d2cd8117fecde097b228633ce))
* enable the definition of conda pin files in order to freeze an environment. This can drastically increase the robustness because it allows to freeze an environment at a working state. ([#1667](https://github.com/john-hen/snakemake/issues/1667)) ([53972bf](https://github.com/john-hen/snakemake/commit/53972bfddcca836d5abb8cdd452cbea40ab2571f))
* fail with an error if snakemake cannot write job metadata. ([#1273](https://github.com/john-hen/snakemake/issues/1273)) ([cd968cd](https://github.com/john-hen/snakemake/commit/cd968cd03437ad6db1d791f5d7ae5295b9754137))
* for small files, compare checksums to determine if job needs to run if input file is newer than output file ([#1568](https://github.com/john-hen/snakemake/issues/1568)) ([1ae85c6](https://github.com/john-hen/snakemake/commit/1ae85c6b57b3c6b5860214a9c0e3ab28c7c8c5dc))
* Group resources ([#1218](https://github.com/john-hen/snakemake/issues/1218)) ([a8014d0](https://github.com/john-hen/snakemake/commit/a8014d030a2a3ea04743e30bcf5164801291378f))
* implement support for removing GFAL remote files ([#1103](https://github.com/john-hen/snakemake/issues/1103)) ([25943e5](https://github.com/john-hen/snakemake/commit/25943e5630ff6d83afa5cba28edf473ce2ca87da))
* improved reports: more interactive and modern interface, ability to define a label based representation of files ([#1470](https://github.com/john-hen/snakemake/issues/1470)) ([d09df0c](https://github.com/john-hen/snakemake/commit/d09df0c6b02494829345f0af0fa8811007afa28b))
* LockException ([#1276](https://github.com/john-hen/snakemake/issues/1276)) ([f5e6fa6](https://github.com/john-hen/snakemake/commit/f5e6fa68a68640ed39df86c256d676f2e4efddfc))
* make it possible to exclude rules that will be imported when using 'use rule' statement ([#1717](https://github.com/john-hen/snakemake/issues/1717)) ([d9e0611](https://github.com/john-hen/snakemake/commit/d9e061178bd22307cc710bea28a5994e866260d9))
* new directive "retries" for annotating the number of times a job shall be restarted after a failure ([#1649](https://github.com/john-hen/snakemake/issues/1649)) ([c8d81d0](https://github.com/john-hen/snakemake/commit/c8d81d03de2885d5d0473084141e9f6abc5de445))
* print reason summary in case of dryrun ([#1778](https://github.com/john-hen/snakemake/issues/1778)) ([bd2a68b](https://github.com/john-hen/snakemake/commit/bd2a68bb8a7ddb64ad91bb822aa7d0342e884704))
* require at least Python 3.7 ([fd5daae](https://github.com/john-hen/snakemake/commit/fd5daaeff070f9987dba411a0f5262c533a2f666))
* specify conda environments via their name ([#1340](https://github.com/john-hen/snakemake/issues/1340)) ([735ab23](https://github.com/john-hen/snakemake/commit/735ab2301d0905ea054ad6efa3150acb296d0e78))
* Support conda environment definitions to be passed as function pointers, similar to input, params, and resources ([#1300](https://github.com/john-hen/snakemake/issues/1300)) ([6f582f1](https://github.com/john-hen/snakemake/commit/6f582f180f5df9292e005623f093a3a0b2e597a7))
* support for group local jobs by enabling optional groupid consideration in input functions ([#1418](https://github.com/john-hen/snakemake/issues/1418)) ([5d45493](https://github.com/john-hen/snakemake/commit/5d45493db4485af2f4b288b5002605c87315d2b7))
* Support for machine_type for kubernetes executor ([#1291](https://github.com/john-hen/snakemake/issues/1291)) ([12d6f67](https://github.com/john-hen/snakemake/commit/12d6f67a19a55ead092c80b2e5b49e1836fb4e5f))
* support for post deploy scripts ([#1325](https://github.com/john-hen/snakemake/issues/1325)) ([e5dac4f](https://github.com/john-hen/snakemake/commit/e5dac4ff297b7aeeb1e1a0bbdd03cb967cee3011))
* support XRootD as a default remote provider ([#1017](https://github.com/john-hen/snakemake/issues/1017)) ([fe03157](https://github.com/john-hen/snakemake/commit/fe03157c31210984fce53c35d5fb87b20d278fe7))
* template rendering integration (yte and jinja2), require Python 3.6 as minimum version (f-string support) ([#1410](https://github.com/john-hen/snakemake/issues/1410)) ([e1cbde5](https://github.com/john-hen/snakemake/commit/e1cbde5a378a29e3e7c7c16c73e08b35afa47a56))
* vim syntax updates ([#1584](https://github.com/john-hen/snakemake/issues/1584)) ([b8c77f6](https://github.com/john-hen/snakemake/commit/b8c77f6a2a1372a5c3ad8077ad36facf393bfacf))
* Zenodo remote provider for transparent storage on and retrieval from Zenodo ([#1455](https://github.com/john-hen/snakemake/issues/1455)) ([4586ef7](https://github.com/john-hen/snakemake/commit/4586ef7c9e5945568e9994a013235574c24d582f))


### Bug Fixes

* --conda-frontend value not passed on to cluster jobs ([#1317](https://github.com/john-hen/snakemake/issues/1317)) ([df46ddb](https://github.com/john-hen/snakemake/commit/df46ddb37022b291a4feca22fd0fbcf8773e7d03))
* add about page to report, including embedded packages and licenses ([#1511](https://github.com/john-hen/snakemake/issues/1511)) ([142a452](https://github.com/john-hen/snakemake/commit/142a45256f1b192246dd8e9843abedb24badecc6))
* Add back logging of run directives ([#1883](https://github.com/john-hen/snakemake/issues/1883)) ([a65559c](https://github.com/john-hen/snakemake/commit/a65559c1e21d65e5b4509b9565b472e734ab9f02))
* add local marker for input files in cufflinks example. fixes issue [#1362](https://github.com/john-hen/snakemake/issues/1362) ([90bc88b](https://github.com/john-hen/snakemake/commit/90bc88b84282b477f481e368ad657056e131cbdc))
* add lock free mechanism for avoiding race conditions when writing persistence information; consider corrupt metadata records as non-existent ([#1745](https://github.com/john-hen/snakemake/issues/1745)) ([71fe952](https://github.com/john-hen/snakemake/commit/71fe9527bb7011ba01d25fdd21c102c135412c04))
* add missing report.templates.components module to setup.py ([cb4e3fe](https://github.com/john-hen/snakemake/commit/cb4e3feaa192ed9c53ddb7c965cb5b71297710c9))
* add quotes to each item of the wait_for_files list ([#1160](https://github.com/john-hen/snakemake/issues/1160)) ([72856ed](https://github.com/john-hen/snakemake/commit/72856edd12fbe29d723731c6f596f05cd2b59c0e))
* add_stylesheet() was deprecated in Sphing v1.8 ([#1071](https://github.com/john-hen/snakemake/issues/1071)) ([#1076](https://github.com/john-hen/snakemake/issues/1076)) ([0a79b33](https://github.com/john-hen/snakemake/commit/0a79b331ddb644693150171440fcffe76291524a))
* Adds fixes for the first two MREs in [#823](https://github.com/john-hen/snakemake/issues/823) ([#1215](https://github.com/john-hen/snakemake/issues/1215)) ([cfd2f89](https://github.com/john-hen/snakemake/commit/cfd2f890a0af57628f7b9278d8d43f59b7006825))
* allocation of local ssds in k8s tests ([#1870](https://github.com/john-hen/snakemake/issues/1870)) ([d0de4dc](https://github.com/john-hen/snakemake/commit/d0de4dccf6f6c749da0d4a30ef27fe0f9274995d))
* allow apptainer as a successor to singularity. ([#1706](https://github.com/john-hen/snakemake/issues/1706)) ([bcbdb0b](https://github.com/john-hen/snakemake/commit/bcbdb0bc44746961838f9603e42d0e171407c740))
* allow labels function to return None ([#1565](https://github.com/john-hen/snakemake/issues/1565)) ([fef74d6](https://github.com/john-hen/snakemake/commit/fef74d6406a04e29c115a699e76ac96e4a37cf9e))
* allow script directive to take pathlib Path ([#1869](https://github.com/john-hen/snakemake/issues/1869)) ([12cdc96](https://github.com/john-hen/snakemake/commit/12cdc961c86541d5c50533a6b8ff5df0cb6fd7d1))
* allow to use {wildcards} for group jobs in cluster config ([#1555](https://github.com/john-hen/snakemake/issues/1555)) ([f0ec73d](https://github.com/john-hen/snakemake/commit/f0ec73d2470d3ecf1d8500b52fa86021463a96fe))
* always deploy conda envs in main process when assuming a shared file system (fixes issue [#1463](https://github.com/john-hen/snakemake/issues/1463)) ([#1472](https://github.com/john-hen/snakemake/issues/1472)) ([79788eb](https://github.com/john-hen/snakemake/commit/79788eb5e8bd404e507ef7e54a0caa6103d90c4e))
* always recalculate job resources before job is scheduled as input might have changed or not have been present initially ([#1552](https://github.com/john-hen/snakemake/issues/1552)) ([44aacdb](https://github.com/john-hen/snakemake/commit/44aacdbb35879e1d7914aa105401541465387955))
* always wait for input files before starting jobs, also upon local execution and within group jobs. This should add further robustness against NFS latency issues. ([#1486](https://github.com/john-hen/snakemake/issues/1486)) ([cab2adb](https://github.com/john-hen/snakemake/commit/cab2adbc2278a2c1689414d2a3f172bb1d5c84d1))
* AmbiguousRuleException bug caused by weak ordering of rules ([#1124](https://github.com/john-hen/snakemake/issues/1124)) ([7f54c39](https://github.com/john-hen/snakemake/commit/7f54c391f2821655ed168bcdafad6d07b96fcec7))
* async_run to allow nested event loops. ([#1170](https://github.com/john-hen/snakemake/issues/1170)) ([5dc6bbd](https://github.com/john-hen/snakemake/commit/5dc6bbd440ac46e81a926b6749969b98b7e33a9f))
* atomic job error display ([#1326](https://github.com/john-hen/snakemake/issues/1326)) ([aa2c265](https://github.com/john-hen/snakemake/commit/aa2c2652608d3e95ad7fb568df09ef1ae09e1def))
* avoid "Admin" prompt when using conda on windows ([#1046](https://github.com/john-hen/snakemake/issues/1046)) ([552fadf](https://github.com/john-hen/snakemake/commit/552fadf7d0ea0f0ff3990295db2618a31c692f61))
* avoid erroneous too early deletion of parent directories in case of failed jobs (thanks to @SichongP). ([#1601](https://github.com/john-hen/snakemake/issues/1601)) ([b0917e6](https://github.com/john-hen/snakemake/commit/b0917e6f07e356764880632495ec3567ec8555b4))
* avoid incomplete remote files in case of errors and automatically retry download and upload ([#1432](https://github.com/john-hen/snakemake/issues/1432)) ([8fc23ed](https://github.com/john-hen/snakemake/commit/8fc23ed09f9c6de7519160797584ff9df3104939))
* avoid mutable default argument ([#1330](https://github.com/john-hen/snakemake/issues/1330)) ([978cc93](https://github.com/john-hen/snakemake/commit/978cc9327ce7deb517ad609977e1ce432c58c5e2))
* avoid superfluous calls of conda info that have slowed down Snakemake since 6.4.1. ([#1099](https://github.com/john-hen/snakemake/issues/1099)) ([e990927](https://github.com/john-hen/snakemake/commit/e9909273c22a316dbd7301a243498e3c2a372642))
* better error message in case of failing to create conda env ([#1526](https://github.com/john-hen/snakemake/issues/1526)) ([e7a461c](https://github.com/john-hen/snakemake/commit/e7a461ce7b5626e603784da27aa4c87649f5edec))
* better error messages in case of missing files after latency period ([#1528](https://github.com/john-hen/snakemake/issues/1528)) ([5b394c0](https://github.com/john-hen/snakemake/commit/5b394c0319cfc5f8000b616d0f3c911a9091d05b))
* bug in pipe group handling that led to multiple assignments of the same group id to different groups; bug that accidentally added already running groups of the list of ready jobs (issue [#1331](https://github.com/john-hen/snakemake/issues/1331)) ([#1332](https://github.com/john-hen/snakemake/issues/1332)) ([1a9b483](https://github.com/john-hen/snakemake/commit/1a9b483a6c675315d74bff791502c2bdd74609c1))
* Bugfix tes add files ([#1133](https://github.com/john-hen/snakemake/issues/1133)) ([8892bf2](https://github.com/john-hen/snakemake/commit/8892bf25d9d981a4032d5a1b525960ba3bdd1aec))
* caching process ([#1225](https://github.com/john-hen/snakemake/issues/1225)) ([0825a29](https://github.com/john-hen/snakemake/commit/0825a29e46c08b200efe6bd0c66acf1e6828eed8))
* catch errors in remote.AUTO provider list ([#1834](https://github.com/john-hen/snakemake/issues/1834)) ([c613ed2](https://github.com/john-hen/snakemake/commit/c613ed217f1dfb16fc63fa7b06af4ddf4f3dd0b8))
* check for skipped rules in case of local rule inheritance ([#1631](https://github.com/john-hen/snakemake/issues/1631)) ([9083ac1](https://github.com/john-hen/snakemake/commit/9083ac1f40daf3d284ce9b1ac2d4addde9b5b258))
* cleaned up and rewritten execution backend structure, (fixing [#1475](https://github.com/john-hen/snakemake/issues/1475), [#860](https://github.com/john-hen/snakemake/issues/860), [#1007](https://github.com/john-hen/snakemake/issues/1007), [#1008](https://github.com/john-hen/snakemake/issues/1008)) (PR [#1491](https://github.com/john-hen/snakemake/issues/1491)) ([e87cc97](https://github.com/john-hen/snakemake/commit/e87cc979bea0567e1cd97722d385f472857df83c))
* conda python interpreter path on Windows ([#1711](https://github.com/john-hen/snakemake/issues/1711)) ([155c9d6](https://github.com/john-hen/snakemake/commit/155c9d6688a99db4b49c5b25d5a8a65a3aca532d))
* consider post-deploy script for env hashing   ([#1363](https://github.com/john-hen/snakemake/issues/1363)) ([d50efd9](https://github.com/john-hen/snakemake/commit/d50efd9d16d029fb0e5b14b182882c71a20552bb))
* consistently use text output in conda shell commands and various little fixes for failing test cases due to conda package changes ([#1864](https://github.com/john-hen/snakemake/issues/1864)) ([4234fe7](https://github.com/john-hen/snakemake/commit/4234fe765e996dbb3a1738567299ebb4d8c28af0))
* convert conda env to string before checks ([#1382](https://github.com/john-hen/snakemake/issues/1382)) ([7a8da9f](https://github.com/john-hen/snakemake/commit/7a8da9fbf01a037a99ebaa3732fe25e87a96fcd2))
* correct handling of exceptions in input functions that are generators ([#1536](https://github.com/john-hen/snakemake/issues/1536)) ([d9a56aa](https://github.com/john-hen/snakemake/commit/d9a56aaf75c5f70ba0217d9d461d839fa3013f2e))
* declare associative arrays ([#1844](https://github.com/john-hen/snakemake/issues/1844)) ([90ae449](https://github.com/john-hen/snakemake/commit/90ae44943a6b7712d46677364752bf0a7cf91806))
* disable mtime retrieval from github api for now. This quickly exceeds rate limits. ([1858bb9](https://github.com/john-hen/snakemake/commit/1858bb912823da2021f88a9c0cdabe1ee1083575))
* Disable Persistence cache for snakemake jobs ([#1159](https://github.com/john-hen/snakemake/issues/1159)) ([7110f9d](https://github.com/john-hen/snakemake/commit/7110f9d2e7ee3f350bd1da3c5b4aab98c06725a1))
* display change warnings only for jobs that won't be executed otherwise ([086f60f](https://github.com/john-hen/snakemake/commit/086f60f142721a6085b105bc4bbe12cccc9cee02))
* display wrapper or external script code in report [#1393](https://github.com/john-hen/snakemake/issues/1393) ([#1404](https://github.com/john-hen/snakemake/issues/1404)) ([a007bd1](https://github.com/john-hen/snakemake/commit/a007bd11fb49a5765a643ec78e19f30b3a10dfab))
* do not apply module prefix in case of remote files ([5645b3f](https://github.com/john-hen/snakemake/commit/5645b3f75066d8d1d8841b6e6732cd8ad098f67f))
* do not pass SNAKEMAKE_PROFILE into cluster-submit ([#1398](https://github.com/john-hen/snakemake/issues/1398)) ([#1407](https://github.com/john-hen/snakemake/issues/1407)) ([7189183](https://github.com/john-hen/snakemake/commit/71891839e397130fb1af3e499d30fa9a953a93f7))
* do not remove existing temp files in case of dryrun ([#1543](https://github.com/john-hen/snakemake/issues/1543)) ([e820f97](https://github.com/john-hen/snakemake/commit/e820f973ad8ca99822be69c927c7d7bf6a89f54e))
* do not require --cores or --jobs to be set when --cleanup-metadata is used. ([#1429](https://github.com/john-hen/snakemake/issues/1429)) ([9c73907](https://github.com/john-hen/snakemake/commit/9c739079bf3e6340facaa03f88f757df36f6dd91))
* do not skip local conda env creation per se when having no shared FS, because it is still needed for local jobs. Instead, decide for each env whether it is needed locally or not. ([#1490](https://github.com/john-hen/snakemake/issues/1490)) ([3f03c5d](https://github.com/john-hen/snakemake/commit/3f03c5d303fbdd9e05aa13a4d93bce08cade32b2))
* do not wait for named or containerized conda envs ([#1473](https://github.com/john-hen/snakemake/issues/1473)) ([6b1d09c](https://github.com/john-hen/snakemake/commit/6b1d09c1e270348e8ef77d6ad8c24e1ca540215c))
* do not wrap whitespace in result info headers of reports ([653d0d0](https://github.com/john-hen/snakemake/commit/653d0d0b92d2556e0fa04a8208f37fd982dcb829))
* don't raise WorkflowError when entry is empty ([#1368](https://github.com/john-hen/snakemake/issues/1368)) ([1fc6f7b](https://github.com/john-hen/snakemake/commit/1fc6f7b5d7e7d7f40baab961db89c4b59c950bf7))
* Draft notebook filename with wildcards and params. ([#1352](https://github.com/john-hen/snakemake/issues/1352)) ([11d4dc8](https://github.com/john-hen/snakemake/commit/11d4dc88598ffb901450bd4e076b91f4e27d37b0))
* dummy release ([e4dca50](https://github.com/john-hen/snakemake/commit/e4dca508f6cbd3427d8580ef61f274f909ec8bab))
* efficient job status checking when using DRMAA API (this should yield much better parallelization and performance when using --drmaa) ([#1156](https://github.com/john-hen/snakemake/issues/1156)) ([ac004cb](https://github.com/john-hen/snakemake/commit/ac004cb19cebd4efb5e38f6039861a2810c702ff))
* enable usage of job grouping in GLS ([#1054](https://github.com/john-hen/snakemake/issues/1054)) ([d243c22](https://github.com/john-hen/snakemake/commit/d243c22ff494b63bd5e07b7c5bf1f6ff32539cde))
* ensure that rule inheritance considers the same globals and other settings as parent module ([#1621](https://github.com/john-hen/snakemake/issues/1621)) ([104cab9](https://github.com/john-hen/snakemake/commit/104cab97d9e1a7dda4c9948efa5883d5478d2229))
* ensures that REncoder also checks for numpy.bool_ in encode_value ([#1749](https://github.com/john-hen/snakemake/issues/1749)) ([10a6e1d](https://github.com/john-hen/snakemake/commit/10a6e1de50ea7957e8685ba55b2cc115101cc23f))
* env file usage after changes to source file handling (inspired by [#1233](https://github.com/john-hen/snakemake/issues/1233) and [#1211](https://github.com/john-hen/snakemake/issues/1211)). ([#1236](https://github.com/john-hen/snakemake/issues/1236)) ([3ac8e85](https://github.com/john-hen/snakemake/commit/3ac8e858a7b908326922c8f68cae512b1250e906))
* fail with error if conda installation is not set to strict channel priorities ([#1672](https://github.com/john-hen/snakemake/issues/1672)) ([f1ffbf2](https://github.com/john-hen/snakemake/commit/f1ffbf28f04150c6e66297f242b768a22f80bd94))
* failure to properly apply default remote prefix in combination with the unpack marker ([#1448](https://github.com/john-hen/snakemake/issues/1448)) ([82666f1](https://github.com/john-hen/snakemake/commit/82666f1b2b043f0a8de739d7027aba66eccdaee3))
* fix `--immediate-submit` ([#1851](https://github.com/john-hen/snakemake/issues/1851)) ([e358372](https://github.com/john-hen/snakemake/commit/e3583721f2dc620ce96876ecec58846d1cbe7bfd))
* fix a bug leading to duplicate conda env initializations; fix display of jobs and output files with changes ([994b151](https://github.com/john-hen/snakemake/commit/994b1510766083df7f22d10c0e6e4bb65ffdd710))
* fix assertion error in conda env file spec when applying wildcards (thanks [@ddesvillechabrol](https://github.com/ddesvillechabrol)) ([#1377](https://github.com/john-hen/snakemake/issues/1377)) ([6200652](https://github.com/john-hen/snakemake/commit/6200652b9aff2362a63581cee58eb9f9cae189da))
* Fix case of multiple scattergather processes ([#1799](https://github.com/john-hen/snakemake/issues/1799)) ([417aad4](https://github.com/john-hen/snakemake/commit/417aad4c1a5fe83bdf24729d0d4e70df112fd293))
* fix errors occurring when refering to input func via rules.<rulename>.input ([#1669](https://github.com/john-hen/snakemake/issues/1669)) ([28a4795](https://github.com/john-hen/snakemake/commit/28a47959bca2d135f82f9d8901b2b0aa228f30cb))
* fix falsely triggered reruns if input files are obtained via workflow.source_path() ([#1862](https://github.com/john-hen/snakemake/issues/1862)) ([2dc2e6a](https://github.com/john-hen/snakemake/commit/2dc2e6aa3255b8b73e06b7af1ea646d5081799ce))
* fix function call when creating report and hashes for between workflow caching ([#1198](https://github.com/john-hen/snakemake/issues/1198)) ([a4f6836](https://github.com/john-hen/snakemake/commit/a4f68365125c357f30510d0e61036f98b9d3aa69))
* fix issue when generating unit tests for rules with directory output ([#1385](https://github.com/john-hen/snakemake/issues/1385)) ([7db614f](https://github.com/john-hen/snakemake/commit/7db614fa1753179d2cdc20095df17d5ac2885ad0))
* fix None type error when invoking Workflow object manually ([#1366](https://github.com/john-hen/snakemake/issues/1366)) ([fca3895](https://github.com/john-hen/snakemake/commit/fca3895430c206fc159e71622ee567f77566980d))
* fix path returned by get_source() ([ee05315](https://github.com/john-hen/snakemake/commit/ee053153d2f44156171c127307cb110791b7624a))
* fix pepfile handling in case of module usage ([#1387](https://github.com/john-hen/snakemake/issues/1387)) ([f097a76](https://github.com/john-hen/snakemake/commit/f097a761472248d779113cdb22b5274395828bcb))
* fix regression in workflow source acquisition of google life science executor ([#1773](https://github.com/john-hen/snakemake/issues/1773)) ([c07732e](https://github.com/john-hen/snakemake/commit/c07732e2c7d6e95fabb3f2570bf0a1b0af2ac2cb))
* fix singularity logging messages causing conda fail ([#1523](https://github.com/john-hen/snakemake/issues/1523)) ([7797595](https://github.com/john-hen/snakemake/commit/77975952ce7df346729f76a767ad4f475b385306))
* fix source cache handling for remote source files retrieved via github() or gitlab() tags. ([#1322](https://github.com/john-hen/snakemake/issues/1322)) ([6e2ecd2](https://github.com/john-hen/snakemake/commit/6e2ecd26e48eb64fa04c9c38dde591857e03c722))
* fix source retrieval during between workflow caching and report generation ([2394ca4](https://github.com/john-hen/snakemake/commit/2394ca4a23a6b2792397bc9efc09945f01d1963b))
* Fix technical bugs in resource-scope documentation ([#1784](https://github.com/john-hen/snakemake/issues/1784)) ([878420c](https://github.com/john-hen/snakemake/commit/878420c4496562df7fe5fed4e6f877e670dcd533))
* fixed bug in missing input file handling for cluster jobs ([#1544](https://github.com/john-hen/snakemake/issues/1544)) ([40e2eb2](https://github.com/john-hen/snakemake/commit/40e2eb2e6c6e31c7cc590c8d643e0640e9377aa4))
* fixed bug in needrun computation of jobs downsteam of checkpoints ([#1704](https://github.com/john-hen/snakemake/issues/1704)) ([c634b78](https://github.com/john-hen/snakemake/commit/c634b78b4d7c4f6ef59e46c94162893e42de6f73))
* fixed code change detection ([#1513](https://github.com/john-hen/snakemake/issues/1513)) ([67298c6](https://github.com/john-hen/snakemake/commit/67298c6167ccaef5f9fbd03ec6b4fe65d86e9ca3))
* fixed code change detection when using modules ([#1264](https://github.com/john-hen/snakemake/issues/1264)) ([b571e09](https://github.com/john-hen/snakemake/commit/b571e09ce452f6a1a95395e1c3c8b9e3f83867ad))
* fixed conda frontend detection and checking to also work with latest mambaforge ([#1781](https://github.com/john-hen/snakemake/issues/1781)) ([225e68c](https://github.com/john-hen/snakemake/commit/225e68cb05ecbf8fe001a884a416da0239cfd4d1))
* fixed detection of norun rules inside of modules ([#1566](https://github.com/john-hen/snakemake/issues/1566)) ([d2223d4](https://github.com/john-hen/snakemake/commit/d2223d41dfba057ab735395eac8339c27866c2ae))
* fixed display of any exceptions and errors from within a workflow definition ([23d40d9](https://github.com/john-hen/snakemake/commit/23d40d99614a88fd3c596d05e6915509ae43d4ce))
* fixed handling of input functions and unpack when using the prefix setting of module definitions ([#1553](https://github.com/john-hen/snakemake/issues/1553)) ([d561e04](https://github.com/john-hen/snakemake/commit/d561e041a8919717046be0d39f197b2c6b937cb7))
* fixed parsing of subsequent use rule statements directly beneath each other ([#1548](https://github.com/john-hen/snakemake/issues/1548)) ([77d5a08](https://github.com/john-hen/snakemake/commit/77d5a08ab49d67b8cbd8ea4b6b6b7792edb38e3b))
* fixed permission issues when using zenodo remote provider to access restricted depositions ([#1634](https://github.com/john-hen/snakemake/issues/1634)) ([510f534](https://github.com/john-hen/snakemake/commit/510f534ff55635e5c3ca677e0ccd8c5b5dd7ca0f))
* fixed temp file deletion for group jobs ([#1487](https://github.com/john-hen/snakemake/issues/1487)) ([d030443](https://github.com/john-hen/snakemake/commit/d030443548a9851a82bcce618b24a9e24a8b545d))
* fixed typos ([#1847](https://github.com/john-hen/snakemake/issues/1847)) ([a1e49b6](https://github.com/john-hen/snakemake/commit/a1e49b6f290daeb2012575ab3a85ca72cfe42747))
* Ga4gh tes bugfixes ([#1127](https://github.com/john-hen/snakemake/issues/1127)) ([af21d6c](https://github.com/john-hen/snakemake/commit/af21d6c2b125c22ef3dbc36a0a6a67a1874549c7))
* handle benmark bug that arise with singularity ([#1671](https://github.com/john-hen/snakemake/issues/1671)) ([10ef7c4](https://github.com/john-hen/snakemake/commit/10ef7c4d1cbbd89fa1760ec9f643e09ae4eb8bd9))
* handle config file extension/overwriting more explicitly ([#1251](https://github.com/john-hen/snakemake/issues/1251)) ([d0a7bf2](https://github.com/john-hen/snakemake/commit/d0a7bf243c5df204136fa1f14706aab793793c68))
* Handle temp files for all jobs in a group. ([#1779](https://github.com/john-hen/snakemake/issues/1779)) ([d28b893](https://github.com/john-hen/snakemake/commit/d28b89363f007d303d733b2b12f517502867035c))
* handling of remaining jobs when using --keep-going ([#1693](https://github.com/john-hen/snakemake/issues/1693)) ([87e4303](https://github.com/john-hen/snakemake/commit/87e430354b45c702e4d782bad8461fde44477a48))
* implement lock-free source file caching. This avoids hangs on network file systems like NFS. ([#1464](https://github.com/john-hen/snakemake/issues/1464)) ([9520e98](https://github.com/john-hen/snakemake/commit/9520e988a32f0c5369b4f2c68fdb741f21daa1a4))
* improve robustness when retrieving remote source files, fixed usage of local git repos as wrapper prefixes (in collaboration with [@cokelaer](https://github.com/cokelaer) and @Smeds) ([#1495](https://github.com/john-hen/snakemake/issues/1495)) ([e16531d](https://github.com/john-hen/snakemake/commit/e16531d6d35b5eb3f7d19008e3e9c4432c4b2e69))
* improved display of percentage of done jobs ([1fee8c0](https://github.com/john-hen/snakemake/commit/1fee8c06d6ed229d7e3757de3c693e755d01d1bb))
* improved error handling for cluster status scripts and smarter job selector choice in case of cluster submission (use greedy for single jobs). ([#1142](https://github.com/john-hen/snakemake/issues/1142)) ([48d2dd9](https://github.com/john-hen/snakemake/commit/48d2dd99a745fd54b74b1435cbb7e41e0ee1b4ac))
* improved error message in case of target rule misspecification ([83b1f5b](https://github.com/john-hen/snakemake/commit/83b1f5bbde437e13641be2160f4855f54043c046))
* improved provenance trigger info ([#1720](https://github.com/john-hen/snakemake/issues/1720)) ([29d959d](https://github.com/john-hen/snakemake/commit/29d959d86341aee66e945f216cae41e9c531a4d1))
* in google live science backend, save multiple logs per rule name and overwrite existing logs ([#1504](https://github.com/john-hen/snakemake/issues/1504)) ([9e92d63](https://github.com/john-hen/snakemake/commit/9e92d63b9e68b29ccd680c34171994b0a2041efb))
* in rules from imported modules, exclude modified paths from module prefixing ([#1494](https://github.com/john-hen/snakemake/issues/1494)) ([1e73db0](https://github.com/john-hen/snakemake/commit/1e73db0325f407529108acc689a915ff23611b5a))
* Initialize assignments dictionary when setting rule-based resources ([#1154](https://github.com/john-hen/snakemake/issues/1154)) ([68c13fd](https://github.com/john-hen/snakemake/commit/68c13fd6fb2ad458e79bafe146499b601bf4bd0e))
* iRODS functionality - issue [#1510](https://github.com/john-hen/snakemake/issues/1510) ([#1611](https://github.com/john-hen/snakemake/issues/1611)) ([9c3767d](https://github.com/john-hen/snakemake/commit/9c3767d6ee13a2c149a4ffe1c0547cabec0346dd))
* issue [#1069](https://github.com/john-hen/snakemake/issues/1069) ([#1077](https://github.com/john-hen/snakemake/issues/1077)) ([7e34fda](https://github.com/john-hen/snakemake/commit/7e34fdaab6f1cc6257c449034cd49c4219eaf8e0))
* Issue [#1253](https://github.com/john-hen/snakemake/issues/1253) (problems editing Jupyter Notebooks) ([#1255](https://github.com/john-hen/snakemake/issues/1255)) ([3398ddf](https://github.com/john-hen/snakemake/commit/3398ddffd1f68182af768ef4ea519e9a9ad4efaf))
* issue [#1257](https://github.com/john-hen/snakemake/issues/1257) (missing logfile failure when using shadow directory) ([#1258](https://github.com/john-hen/snakemake/issues/1258)) ([426d92f](https://github.com/john-hen/snakemake/commit/426d92fd9610b61b414b7f0152d777c463c939a2))
* issue 1615 - Switch formatting condition for dictionary ([#1617](https://github.com/john-hen/snakemake/issues/1617)) ([0771062](https://github.com/john-hen/snakemake/commit/0771062a07f0e2cfe9ee45a2276aa61b096eb6e1))
* issue with duplicated prefix for checkpoints on cloud ([#1294](https://github.com/john-hen/snakemake/issues/1294)) ([8ed0c8c](https://github.com/john-hen/snakemake/commit/8ed0c8cb453b6ebf6df138391a0681ffc8442e09))
* issue1460 intermediate files existing (or not) ([#1541](https://github.com/john-hen/snakemake/issues/1541)) ([1b3ede1](https://github.com/john-hen/snakemake/commit/1b3ede19159856a982de65e6293ab064c0987352))
* k8s container volume mounts as list ([#1868](https://github.com/john-hen/snakemake/issues/1868)) ([5c54df3](https://github.com/john-hen/snakemake/commit/5c54df39c6a111dcfa7adaea15d0b81a3fc16b90))
* keep empty output and input dirs of --draft-notebook job ([f1181bd](https://github.com/john-hen/snakemake/commit/f1181bd41ea8b20fafd3975c2733ca1d439381dc))
* keep flags with apply_wildcards on cloned IOFile ([#1416](https://github.com/john-hen/snakemake/issues/1416)) ([23c943f](https://github.com/john-hen/snakemake/commit/23c943f0e285f2dc725aa3e4a2e8798021085cb3))
* key error when handling FileNotFoundError in input functions. ([#1138](https://github.com/john-hen/snakemake/issues/1138)) ([d25f04d](https://github.com/john-hen/snakemake/commit/d25f04db820c9651835b7323baef5931d4f8dc0a))
* limit filename length of temporary files generated by the persistence backend (metadata, incomplete markers, etc.) ([#1780](https://github.com/john-hen/snakemake/issues/1780)) ([59053e7](https://github.com/john-hen/snakemake/commit/59053e7017584ea94860cecb5ebecce66aed14ce))
* linting of remote snakefiles ([#1131](https://github.com/john-hen/snakemake/issues/1131)) ([2104e10](https://github.com/john-hen/snakemake/commit/2104e10d1d2c5e0f368e9c0fe95cc50f9d4847f1))
* merging of pipe groups when multiple rules are chained together via pipes ([#1173](https://github.com/john-hen/snakemake/issues/1173)) ([de91d2c](https://github.com/john-hen/snakemake/commit/de91d2ccf53bd844b4dbf4f64dd087f4ee935be5))
* modify dag and workflow display in report to also work for big DAGs ([#1517](https://github.com/john-hen/snakemake/issues/1517)) ([1364dfb](https://github.com/john-hen/snakemake/commit/1364dfbc9db58541aaf5600bca61230f9eb4ecbc))
* more comprehensive error reporting for RuleExceptions ([#1802](https://github.com/john-hen/snakemake/issues/1802)) ([1cd9512](https://github.com/john-hen/snakemake/commit/1cd95129a92e522e11689620473f68b1fe69fb42))
* more details on input and output exceptions (missing input, protected output, etc.) ([#1453](https://github.com/john-hen/snakemake/issues/1453)) ([8d64af2](https://github.com/john-hen/snakemake/commit/8d64af2cb905fef95585055c7b69fd1c45d44108))
* more informative nothing to be done message ([#1234](https://github.com/john-hen/snakemake/issues/1234)) ([368d265](https://github.com/john-hen/snakemake/commit/368d265ff3da984bd3a53b319dcb882d6916975b))
* more robust calculation of number of jobs until ready for execution ([#1691](https://github.com/john-hen/snakemake/issues/1691)) ([fdfc717](https://github.com/john-hen/snakemake/commit/fdfc717f8764ce535801d06805aaa1d59186ec84))
* more robust handling of incompletely evaluated parameters (any interaction with them will result in a string <TBD> now). ([#1525](https://github.com/john-hen/snakemake/issues/1525)) ([3d4c768](https://github.com/john-hen/snakemake/commit/3d4c768aafbdca67a9032ad9e3b73449a1fadb0d))
* more robust place for runtime source file cache ([#1436](https://github.com/john-hen/snakemake/issues/1436)) ([2681f6f](https://github.com/john-hen/snakemake/commit/2681f6f163832dfa5214e10f5234d256f5a13407))
* move max_status_checks_per_second attribute setting before the wait thread of cluster backends is started to avoid missing attribute errors ([#1775](https://github.com/john-hen/snakemake/issues/1775)) ([a48e9d0](https://github.com/john-hen/snakemake/commit/a48e9d035efec3a91b50bbda43ddf92196d5084b))
* Move quiet default after profile parsing ([#1764](https://github.com/john-hen/snakemake/issues/1764)) ([6ade76d](https://github.com/john-hen/snakemake/commit/6ade76d1287c8f62056853491a4e67b08a4739a6))
* mtime inventory for google storage was accidentally setting a float instead of a proper mtime object ([#1484](https://github.com/john-hen/snakemake/issues/1484)) ([7c762c7](https://github.com/john-hen/snakemake/commit/7c762c7e5204f95ca85157ba5fe5ab061b8abdfa))
* multiext prefix computation in case it is used within a module that defines an additional prefix ([#1609](https://github.com/john-hen/snakemake/issues/1609)) ([fc6dfc6](https://github.com/john-hen/snakemake/commit/fc6dfc6469137a82382a36b9469190d967593759))
* None type error when invoking Workflow object manually ([#1731](https://github.com/john-hen/snakemake/issues/1731)) ([dc45ccb](https://github.com/john-hen/snakemake/commit/dc45ccb9ee94e8fcdf386c8598bbae57e319ba10))
* obtaining conda prefix when using in combination with singularity ([#1535](https://github.com/john-hen/snakemake/issues/1535)) ([99b22d3](https://github.com/john-hen/snakemake/commit/99b22d33f2100a7e4cf2d080a2272959a712d055))
* Only --bind Snakemake when we're working with a Python script ([#1206](https://github.com/john-hen/snakemake/issues/1206)) ([1d79f62](https://github.com/john-hen/snakemake/commit/1d79f625b7262d66def71c779f2a2c091bc418d8))
* only consider context of shell command for technical switches if called from snakemake rules. ([#1213](https://github.com/john-hen/snakemake/issues/1213)) ([4816a58](https://github.com/john-hen/snakemake/commit/4816a58653e466ca94b1482a1d947a856f5381b3))
* only display a warning in case of non-strict channel priorities ([#1752](https://github.com/john-hen/snakemake/issues/1752)) ([b84fa33](https://github.com/john-hen/snakemake/commit/b84fa337f5c417360fc744202a419da3f37594b5))
* Open Snakefile for reading with explicit encoding specified ([#1146](https://github.com/john-hen/snakemake/issues/1146)) ([ec1d859](https://github.com/john-hen/snakemake/commit/ec1d859dd2422fa551bbf58843907fc5eed244ff))
* parsing error when combining single line directive with multi-line directive in use rule statements ([#1662](https://github.com/john-hen/snakemake/issues/1662)) ([26e57d6](https://github.com/john-hen/snakemake/commit/26e57d69fc320adc972967a8046c5163b455456c))
* pass triggers and resources to subworkflow ([#1733](https://github.com/john-hen/snakemake/issues/1733)) ([fa7fb75](https://github.com/john-hen/snakemake/commit/fa7fb75d2314cd2965a9f578506e27aae4b07349))
* potential memory corruption caused by Google storage objects accessed from different threads ([#1174](https://github.com/john-hen/snakemake/issues/1174)) ([41a5071](https://github.com/john-hen/snakemake/commit/41a5071b750dca5d7fceec324d81d9a93c86bdb6))
* preserve dtypes across paramspace ([#1578](https://github.com/john-hen/snakemake/issues/1578)) ([70ce6a0](https://github.com/john-hen/snakemake/commit/70ce6a0feb8572ddcf888c3d377d631ea4a24370))
* preserve empty names input or output file lists in params or resource functions ([0d19ab0](https://github.com/john-hen/snakemake/commit/0d19ab0e6fcabe61b49d5ef9f2b293b9bcc06534))
* propagate rerun trigger info to cluster jobs; fix a bug leading to software stack trigger generating false positives in case of conda environments; fixed display of info message in case of provenance triggered reruns ([#1686](https://github.com/john-hen/snakemake/issues/1686)) ([503c70c](https://github.com/john-hen/snakemake/commit/503c70c7727e154f8fadf6ead088887d22a87a65))
* proper error message if resource types do not match ([#1556](https://github.com/john-hen/snakemake/issues/1556)) ([1112321](https://github.com/john-hen/snakemake/commit/11123213188672a3b6e5acfffed18d9e0ccc8819))
* proper error message in case of missing git when checking for source files ([#1534](https://github.com/john-hen/snakemake/issues/1534)) ([92887a3](https://github.com/john-hen/snakemake/commit/92887a33dc3674f942bd0355edfbba53b810f18f))
* proper error message when defining cache eligibility for rules with multiple output files and no multiext declaration. ([#1357](https://github.com/john-hen/snakemake/issues/1357)) ([47b5096](https://github.com/john-hen/snakemake/commit/47b5096ebbdd3d94a9c99b443064b1b0de389c64))
* properly use configfiles specified via CLI also if configfile specified via configfile directive is not present ([1e0649a](https://github.com/john-hen/snakemake/commit/1e0649ac37176a68bb2d8f4d1508ac8bb02463ff))
* properly use retry mechanism in source cache ([#1564](https://github.com/john-hen/snakemake/issues/1564)) ([624a83d](https://github.com/john-hen/snakemake/commit/624a83d1bfc592a2a1878d5191e09f6c3d7ee7c2))
* provide details on error when failing to evaluate default resources ([#1430](https://github.com/john-hen/snakemake/issues/1430)) ([04f39a9](https://github.com/john-hen/snakemake/commit/04f39a92f58c21265d859666bd63fe686e1d61f5))
* provide proper error when using immediate submit in combination with checkpoint jobs. ([#1437](https://github.com/john-hen/snakemake/issues/1437)) ([865cf0f](https://github.com/john-hen/snakemake/commit/865cf0f22656e22cd2450e5537421ce70c1705f9))
* provide temporary IPYTHONDIR for notebook execution in order to avoid race conditions in https://github.com/ipython/ipython/blob/master/IPython/paths.py#L20 upon execution of multiple notebooks at the same time. ([#1280](https://github.com/john-hen/snakemake/issues/1280)) ([4d70da1](https://github.com/john-hen/snakemake/commit/4d70da11f810224ddce192ae1472a6380898865f))
* quote jobid passed to status script to support multi-cluster Slurm setup ([#1459](https://github.com/john-hen/snakemake/issues/1459)) ([0232201](https://github.com/john-hen/snakemake/commit/023220160c6146810e3da2b277439441e8af9827))
* quote workdir in job exec prefix to allow to spaces in the workdir ([#1547](https://github.com/john-hen/snakemake/issues/1547)) ([c3a593e](https://github.com/john-hen/snakemake/commit/c3a593e8f7fc8e0dccec4e025f4cd9743bd80bc3))
* R encoding of pathlib.Path objects ([#1201](https://github.com/john-hen/snakemake/issues/1201)) ([bd516e9](https://github.com/john-hen/snakemake/commit/bd516e958af22e57c18cacf0cb22552c2a237bd8))
* reduce resource requirements for kubernetes tests ([#1876](https://github.com/john-hen/snakemake/issues/1876)) ([cb4b78a](https://github.com/john-hen/snakemake/commit/cb4b78a05ee08f7dafb561ba33bbe460ec097eb5))
* remove accidental pdb statement ([9c935f1](https://github.com/john-hen/snakemake/commit/9c935f1566b976392393aeb00acf0e39eb159e19))
* remove deprecated and add missing arguments to internal functions ([93a7e39](https://github.com/john-hen/snakemake/commit/93a7e39d9f225fac5ff5cb8cbe14500a09986ab3))
* remove raise that limits using --config with dicts ([#1341](https://github.com/john-hen/snakemake/issues/1341)) ([bd65057](https://github.com/john-hen/snakemake/commit/bd65057a782355ede86ad0bb912e063ff25a97f5))
* remove redundant print ([#1608](https://github.com/john-hen/snakemake/issues/1608)) ([cc7e0e3](https://github.com/john-hen/snakemake/commit/cc7e0e3605bd65ffcb2d055e69761ff7337588ae))
* remove superfluous comma causing TypeError in conda-frontend error message ([#1804](https://github.com/john-hen/snakemake/issues/1804)) ([87b013c](https://github.com/john-hen/snakemake/commit/87b013cbba420b71892ab9f482718c1cd59e6bda))
* remove whitespace before `` ([#1067](https://github.com/john-hen/snakemake/issues/1067)) ([bd7951a](https://github.com/john-hen/snakemake/commit/bd7951accc7854255a4d1ebd1edc35e739bac091))
* render empty caption if nothing defined in report flag ([013a6e8](https://github.com/john-hen/snakemake/commit/013a6e8459d0659e05546c849f84151860686004))
* Repair MREs from [#823](https://github.com/john-hen/snakemake/issues/823) ([#1203](https://github.com/john-hen/snakemake/issues/1203)) ([b007979](https://github.com/john-hen/snakemake/commit/b0079791718a390d1f920df15a405cf633314312))
* Replaced pathlib relative_to with os.relpath ([#1505](https://github.com/john-hen/snakemake/issues/1505)) ([dc65e29](https://github.com/john-hen/snakemake/commit/dc65e2921163e9b069c13f79dc0488be21452905))
* report error and possible cause if metadata cleanup fails ([#1554](https://github.com/john-hen/snakemake/issues/1554)) ([6866134](https://github.com/john-hen/snakemake/commit/68661341efa0a3de4e03de3fb1b8f3117de66efe))
* request disk_mb resource from k8s ([#1858](https://github.com/john-hen/snakemake/issues/1858)) ([f68f166](https://github.com/john-hen/snakemake/commit/f68f166582abaeb45a1a093306626bb8abb0e0bb))
* respect shebang lines in post-deploy scripts (see deployment docs) ([#1841](https://github.com/john-hen/snakemake/issues/1841)) ([c26c4b6](https://github.com/john-hen/snakemake/commit/c26c4b6ff43e38797168ef7983c40b0c8a4b2f8c))
* rule inheritance within modules (did previously lead to key errors) ([#1292](https://github.com/john-hen/snakemake/issues/1292)) ([603e0a8](https://github.com/john-hen/snakemake/commit/603e0a87d2c7af57a8f1d397605bc501c50934e0))
* run dependencies with non-existent ancient files before the consuming job ([#1202](https://github.com/john-hen/snakemake/issues/1202)) ([84d1f64](https://github.com/john-hen/snakemake/commit/84d1f6451b12352eba5a8bfefcfcce8b2d98c5aa)), closes [#946](https://github.com/john-hen/snakemake/issues/946)
* SameFileError [#1153](https://github.com/john-hen/snakemake/issues/1153) ([#1220](https://github.com/john-hen/snakemake/issues/1220)) ([ede313d](https://github.com/john-hen/snakemake/commit/ede313dcd31ea5f136b3b8f743e2265331475342))
* set channel priority in container system wide ([#1690](https://github.com/john-hen/snakemake/issues/1690)) ([41175b3](https://github.com/john-hen/snakemake/commit/41175b3001ff59db5d7ea8bf91354decea04f74d))
* set default number of nodes to 1 in test cases ([#1288](https://github.com/john-hen/snakemake/issues/1288)) ([f6e12b4](https://github.com/john-hen/snakemake/commit/f6e12b4798485be3a1bb240b4af44d57dd5c84b2))
* set mtime for cached source files [WIP] ([#1443](https://github.com/john-hen/snakemake/issues/1443)) ([dd27209](https://github.com/john-hen/snakemake/commit/dd27209b4a600d3704cabc39776dfef718129197))
* skip global report caption when using a module ([#1379](https://github.com/john-hen/snakemake/issues/1379)) ([a755cee](https://github.com/john-hen/snakemake/commit/a755ceefa478d51070f926beed9090067771edf1))
* small bug in snakemake.executors ([#1440](https://github.com/john-hen/snakemake/issues/1440)) ([6e64292](https://github.com/john-hen/snakemake/commit/6e64292cfa7d5bd9f6cb786681b3710ee51abc43))
* small changes to make docs checkpoint example functional ([#1714](https://github.com/john-hen/snakemake/issues/1714)) ([1d4909e](https://github.com/john-hen/snakemake/commit/1d4909ef838ac79f8e7be9f29d76b969d358ef1b))
* snakemake API using only 1 job as default ([#1283](https://github.com/john-hen/snakemake/issues/1283)) ([e92ad48](https://github.com/john-hen/snakemake/commit/e92ad4867feb456ce8ef3dc57fd8528affa64ae9))
* status cmd repeats until killed by 11 *different* signals ([#1207](https://github.com/john-hen/snakemake/issues/1207)) ([8b28b57](https://github.com/john-hen/snakemake/commit/8b28b5740c34149c9b5df56dbbfa034219eb1574))
* support multiple input files for template_engine rules ([#1571](https://github.com/john-hen/snakemake/issues/1571)) ([aee7cf2](https://github.com/john-hen/snakemake/commit/aee7cf236611e5201feda152f5b7357b49b9f15b))
* throw error message in case of target rule that depends on a pipe. ([#1532](https://github.com/john-hen/snakemake/issues/1532)) ([b9e9a7e](https://github.com/john-hen/snakemake/commit/b9e9a7eff4b6e3349dde6b90eec9f5a37ef69ce7))
* typo in sourcecache use ([#1229](https://github.com/john-hen/snakemake/issues/1229)) ([8b54bc5](https://github.com/john-hen/snakemake/commit/8b54bc5db9d8e5c0bcb8f2c2ff141dc075e3e659))
* typos in code examples ([#1324](https://github.com/john-hen/snakemake/issues/1324)) ([60010e4](https://github.com/john-hen/snakemake/commit/60010e4ef07b7ba9b89aa5f48ee90ff3cec85b75))
* update for minimum of Python 3.7 ([#1509](https://github.com/john-hen/snakemake/issues/1509)) ([62024e2](https://github.com/john-hen/snakemake/commit/62024e2bfd6d5735763f37a0f4bf43a16f229443))
* Use 'snakemake.utils.update_config' instead of 'dict.update' ([#1126](https://github.com/john-hen/snakemake/issues/1126)) ([2658027](https://github.com/john-hen/snakemake/commit/2658027458dde4c10b3d6e1af7671564d175f9cb))
* use mambaforge for snakemake container image ([#1595](https://github.com/john-hen/snakemake/issues/1595)) ([b7e6906](https://github.com/john-hen/snakemake/commit/b7e6906926cae5fef6987adcf7b0294266d5faec))
* warn on non-file-modification-date changes like params, code, or input files ([#1419](https://github.com/john-hen/snakemake/issues/1419)) ([b5f53f0](https://github.com/john-hen/snakemake/commit/b5f53f09ae8c01e1223d2279c3a7f59819a8b44f))
* wms monitor arg parsing now accepts any kind of value ([#1181](https://github.com/john-hen/snakemake/issues/1181)) ([313de93](https://github.com/john-hen/snakemake/commit/313de932e2e2a4f2c530df18c1abb15d37eb3217))
* work around segfault with >100 jobs in google life sciences backend ([#1451](https://github.com/john-hen/snakemake/issues/1451)) ([2c0fee2](https://github.com/john-hen/snakemake/commit/2c0fee2faec33185ca7fcd2276901977857e2c64))
* XRootDHelper.exists supports non posix filesystem (object store) ([#1348](https://github.com/john-hen/snakemake/issues/1348)) ([7a3ad2f](https://github.com/john-hen/snakemake/commit/7a3ad2f438586690dd40e4c8ec591d8c10b22b00))


### Performance Improvements

* improve job selection performance in case of potential ambiguity that is resolved by comprehensive ruleorder statements. ([#1147](https://github.com/john-hen/snakemake/issues/1147)) ([921f4f7](https://github.com/john-hen/snakemake/commit/921f4f715e3814fc2e22a4f6527ff62e066cc5da))
* more extensive caching of source files, including wrappers. ([#1182](https://github.com/john-hen/snakemake/issues/1182)) ([bdb75f8](https://github.com/john-hen/snakemake/commit/bdb75f828a3ae27ba97ea6cd5e71a34ac7b27eea))


### Documentation

* add install info of development (git) version to docs ([#1477](https://github.com/john-hen/snakemake/issues/1477)) ([2a2d6cd](https://github.com/john-hen/snakemake/commit/2a2d6cd15cf48278ff17470c7c1323e7ebc40bbd))
* add sentence about workflow template to docs ([#1369](https://github.com/john-hen/snakemake/issues/1369)) ([5fabffb](https://github.com/john-hen/snakemake/commit/5fabffbb4af8e9e122677e5adeaebf2d6bd0eeb3))
* add workflows.community metadata ([#1736](https://github.com/john-hen/snakemake/issues/1736)) ([8a42afc](https://github.com/john-hen/snakemake/commit/8a42afc053e3f398f1a299fb3234ca0ee847faae))
* checkpoint documentation ([#1562](https://github.com/john-hen/snakemake/issues/1562)) ([4cbfb47](https://github.com/john-hen/snakemake/commit/4cbfb4786a729a0c899a0a3e0427c1c1f0796c15))
* Clarification of --cluster-stats docs  &  elaborating on the situation where job ids are not passed to the status script ([#1221](https://github.com/john-hen/snakemake/issues/1221)) ([ed0e4a2](https://github.com/john-hen/snakemake/commit/ed0e4a27a2167a69a4fe1bcdf237dd27bb3732ca))
* clarify namespacing when using modules. ([dbed4a3](https://github.com/john-hen/snakemake/commit/dbed4a3f160106feb15a51d2e8cfcafae531ea57))
* Clarify the use of conda with notebook directive ([#1515](https://github.com/john-hen/snakemake/issues/1515)) ([aefb1eb](https://github.com/john-hen/snakemake/commit/aefb1eb0a2d62faa6108670f3a11d58a1d797c41))
* Combine CHANGELOG.rst with CHANGELOG.md ([#1228](https://github.com/john-hen/snakemake/issues/1228)) ([19f5a43](https://github.com/john-hen/snakemake/commit/19f5a43261bd6ba548d6f01080640f0d4119871e))
* Command line arguments for configuration files ([#1343](https://github.com/john-hen/snakemake/issues/1343)) ([ad8aaa4](https://github.com/john-hen/snakemake/commit/ad8aaa4853a150211513baecc474956575d326eb))
* details on benchmarked results ([64fea09](https://github.com/john-hen/snakemake/commit/64fea0921f6a35dbea96435debb114012603ffc2))
* display rust-script env. ([950d8ba](https://github.com/john-hen/snakemake/commit/950d8ba785a384fa47fcda3d6fb948799a259e0e))
* explain automatic decompression strategy for http remote provider ([e6826b6](https://github.com/john-hen/snakemake/commit/e6826b6a740ba5b8877f12732c4ad95194833e07))
* explain relative path interpretation ([#1428](https://github.com/john-hen/snakemake/issues/1428)) ([add9a05](https://github.com/john-hen/snakemake/commit/add9a05eecf10f45113bc511a1d166e1708ff756))
* explain SNAKEMAKE_PROFILE environment variable ([2b32bba](https://github.com/john-hen/snakemake/commit/2b32bba6efa53a9359bc67d8eb8ce06f1106e8ef))
* fix broken link in executor_tutorial/tutorial.rst ([#1360](https://github.com/john-hen/snakemake/issues/1360)) ([c9be764](https://github.com/john-hen/snakemake/commit/c9be76482d05577c4b1528b0e52ba15fc17a1dd5))
* fix contributing executors link ([#1112](https://github.com/john-hen/snakemake/issues/1112)) ([4bb58d1](https://github.com/john-hen/snakemake/commit/4bb58d12a44f77f79d47c5443f927cb6061677f5))
* fix grammar in the intro ([#1859](https://github.com/john-hen/snakemake/issues/1859)) ([774bc6a](https://github.com/john-hen/snakemake/commit/774bc6aaa3105c94a551691498d9a5efb13ac216))
* fix list display in docs ([3724367](https://github.com/john-hen/snakemake/commit/372436747a97496466b60dc60ee0ebe4cfef1016))
* fix list display in docs ([2dd0e91](https://github.com/john-hen/snakemake/commit/2dd0e91f8b7e13d0ffcebe4ed11024a39357ebc7))
* fix long description type for pypi (set to markdown) ([d8d9b8f](https://github.com/john-hen/snakemake/commit/d8d9b8f284d2863f672cd96fd96d2034806d52de))
* Fix problems with code blocks and broken internal link. ([#1424](https://github.com/john-hen/snakemake/issues/1424)) ([5d4e7d8](https://github.com/john-hen/snakemake/commit/5d4e7d8c4d7901c41bfb8f01c4b2c6551add59f7))
* fix small type in FAQ ([#1832](https://github.com/john-hen/snakemake/issues/1832)) ([914172b](https://github.com/john-hen/snakemake/commit/914172baf366570fa2a2818746d3ed1417790e3a))
* Fix syntax error in docs/conf.py and update sphinx.ext.napoleon import ([#1084](https://github.com/john-hen/snakemake/issues/1084)) ([3e3fac2](https://github.com/john-hen/snakemake/commit/3e3fac2dbd5a8abad67e252f6181ad14bcfcb711))
* fix tutorial setup instructions for MacOS. ([#1383](https://github.com/john-hen/snakemake/issues/1383)) ([b57b749](https://github.com/john-hen/snakemake/commit/b57b7493d372605323204122af859ede38864e4d))
* fix typo ([#1843](https://github.com/john-hen/snakemake/issues/1843)) ([6572ad9](https://github.com/john-hen/snakemake/commit/6572ad91bed14dece6b01a26134007a25ef0c4b2))
* Fix typo and grammar mistake in scatter-gather section. ([#1441](https://github.com/john-hen/snakemake/issues/1441)) ([f218aaa](https://github.com/john-hen/snakemake/commit/f218aaad1b9b80074ea602cde0352c34c18e70b5))
* Fix typo in file path in remote files documentation ([#1110](https://github.com/john-hen/snakemake/issues/1110)) ([9ce294f](https://github.com/john-hen/snakemake/commit/9ce294f6d5bdf72055a824ab610488a7f832a4d3))
* fix typo in installation.rst ([#1344](https://github.com/john-hen/snakemake/issues/1344)) ([c45d47a](https://github.com/john-hen/snakemake/commit/c45d47a79b78a1afed3b1319e6cafd1b2525fe43))
* Fix typo in rules.rst (—draft-notebook) ([#1290](https://github.com/john-hen/snakemake/issues/1290)) ([f5c42cf](https://github.com/john-hen/snakemake/commit/f5c42cfdc68f1516cec71b8ead8d78225ae915e5))
* link to list of dependencies from installation ([#1336](https://github.com/john-hen/snakemake/issues/1336)) ([99d7bfe](https://github.com/john-hen/snakemake/commit/99d7bfef1285f131d0e60331511bc4833e7e414a))
* Mention required openssl dep for rust-script ([#1216](https://github.com/john-hen/snakemake/issues/1216)) ([fc8c5f6](https://github.com/john-hen/snakemake/commit/fc8c5f62c397a0239ef213ab45a26a1def50f9eb))
* move note ([75a544b](https://github.com/john-hen/snakemake/commit/75a544ba528b30b43b861abc0ad464db4d6ae16f))
* move psutil import into benchmark methods to avoid needing it as a dependency for doc building ([6ffe38d](https://github.com/john-hen/snakemake/commit/6ffe38d1740294a7170765ab875b363f4ae82cd4))
* polish ([47a7b62](https://github.com/john-hen/snakemake/commit/47a7b628686258a28dd870f20bf1f121b3a881c3))
* require sphinx>=3 ([1773875](https://github.com/john-hen/snakemake/commit/1773875fc8f2fddb09362410afb7c49c4406bfa3))
* separate api docs ([ded7da9](https://github.com/john-hen/snakemake/commit/ded7da90258284f06d4e9263e667cd632cdc12ae))
* separate api docs ([#1499](https://github.com/john-hen/snakemake/issues/1499)) ([5cf275a](https://github.com/john-hen/snakemake/commit/5cf275ab9c556dd1828a0618799bcdba0c561e70))
* short tutorial updates ([#1286](https://github.com/john-hen/snakemake/issues/1286)) ([b653a44](https://github.com/john-hen/snakemake/commit/b653a44d105e4b3799425a695d75a08239dc0d6b))
* singularity sometimes uses system /tmp explanation ([#1588](https://github.com/john-hen/snakemake/issues/1588)) ([170c1d9](https://github.com/john-hen/snakemake/commit/170c1d9d92de4cafc0da9567a6970b173161c7da))
* skip lazy property ([2883718](https://github.com/john-hen/snakemake/commit/28837183fa55a6764621580983b3d724f3881a6a))
* small tweaks to flux documentation ([#1886](https://github.com/john-hen/snakemake/issues/1886)) ([f29b371](https://github.com/john-hen/snakemake/commit/f29b37106727c470b691076189e92f35e4cecfb6))
* temaplte rendering examples and available variables ([#1431](https://github.com/john-hen/snakemake/issues/1431)) ([5995e9e](https://github.com/john-hen/snakemake/commit/5995e9ebf7b037479b3f1317cb920773410bd2f2))
* tutorial formatting ([594f5fb](https://github.com/john-hen/snakemake/commit/594f5fbb342e0722318641dea07d7da4c5eb8116))
* Unpin docutils version ([#1230](https://github.com/john-hen/snakemake/issues/1230)) ([15a82bf](https://github.com/john-hen/snakemake/commit/15a82bfe402b3577bf19e6d2eca3b2fb86109628))
* update contribution docs ([09a5595](https://github.com/john-hen/snakemake/commit/09a559504d7a4346e40d8b3a99ece46e903ff7a0))
* update copyright year ([#1427](https://github.com/john-hen/snakemake/issues/1427)) ([6b9f5da](https://github.com/john-hen/snakemake/commit/6b9f5da0c986d5de444e00b45656dba85244a6c7))
* update URL to emacs snakemake-mode ([#1339](https://github.com/john-hen/snakemake/issues/1339)) ([dae7b8f](https://github.com/john-hen/snakemake/commit/dae7b8fb0e580a1878d36881cfb5ffc8adeaeb9f))
* various little fixes ([#1875](https://github.com/john-hen/snakemake/issues/1875)) ([b93f8e3](https://github.com/john-hen/snakemake/commit/b93f8e316cb2f51e72933e7a28872bdf523aec11))
* zenodo example ([76159ae](https://github.com/john-hen/snakemake/commit/76159ae22539e38923712e487371a5f32d7cb3cf))
